...
if (!isset($_SESSION["usuario"])) {
	...
	<body class="hold-transition skin-blue sidebar-mini">
							...
							<div class="box box-success" style="border:2px solid white;">
								<div class="box-header with-border">
									<button type="button" class="btn btn-success" id="btn_add_carousel">
										<i class="fa fa-plus"></i> Capacitaciones
									</button>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="box box-solid">
								<div class="box-header with-border">
									<center>
										<h5 class="box-title">Nuevo Registro</h5>
									</center>
								</div>
								<div class="box-body">
						...
						<form action="">
							...
							<div class="modal-body">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label for="fecha" class="control-label">Costo</label>
											<input name="costo"  id="costo" type="number" step="0.01" class="form-control" required>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
		...
		<script src="scripts/capacitaciones.js"></script>
