	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Módulo de pasajes
					<small>Gestiona los pasajes de la página principal</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>

					<li class="active">Módulo de pasajes</li>
				</ol>
			</section>
					...
					<div class="col-md-12">
						<div class="box box-success" style="border:2px solid white;">
							<div class="box-header with-border">
								...
								<i class="fa fa-plus"></i> Agregar Pasaje
							  </button>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="box box-solid">
							<div class="box-header with-border">
								<center>
									<h5 class="box-title">Lista de pasajes</h5>
								</center>
							</div>
							<div class="box-body">
...
<form id="formulario_pasajes" class="form">
			...
			<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h4 class="modal-title"><i class="fa fa-newspaper-o"></i> AGREGAR PASAJES</h4>
					</div>
					<div class="modal-body">

							<input type="hidden" name="idpasajes" id="idpasajes">
							<div class="row">
								<div class="col-md-12">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default" id="btn_close_pasaje"><i class="fa fa-close"></i> Cancelar </button>
                  </div>
								</div>
	...
	<script src="scripts/pasajes.js"></script>
