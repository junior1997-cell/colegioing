        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>
                        MIEMBROS DEL CONSEJO DEPARTAMENTAL
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="box" style="border-top: 4px solid #540118 !important;">
                                ...
                                <div class="box-body">
                                    <!-- BOTÓN AGREGAR -->
                                    <button type="button" class="btn btn-success" onclick="limpiarDirectiva();" data-toggle="modal" data-target="#agregar_usuario"><i class="fa fa-user-plus"></i> Agregar Miembro</button> <br />
                                    <br />

                                    <div class="table-responsive">
                                        <table id="ListarDirectivaDepartamental" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form id="formulario_directiva">
                                    <input type="text" id="id_directiva" name="id_directiva" />
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            ...
                                                            <input type="hidden" value="1" name="id_tipo_directiva" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="box box-danger "  >
                                <div class="box-header with-border">
                                    <h3 class="box-title">HISTORIAL DE DIRECTIVA DEPARTAMENTAL</h3>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="historial_directiva_departmental" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
