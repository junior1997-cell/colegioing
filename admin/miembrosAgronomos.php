        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>
                        MIEMBROS DEL CAP. AGRONOMOS Y AFINES
                            ...
                            <div class="box" style="border-top: 4px solid #540118 !important;">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="ListarDirectivaAgronomo" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            ...
                                                            <input type="hidden" value="2" name="id_tipo_directiva" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="box box-danger "  >
                                <div class="box-header with-border">
                                    <h3 class="box-title">HISTORIAL DEl CAP. AGRONOMOS Y AFINES </h3>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="historial_directiva_agronomo" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
