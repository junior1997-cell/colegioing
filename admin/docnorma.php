                        ...
                        <div class="modal-dialog modal-lg ">
                            <div class="modal-content">
                                ...
                                <form id="formulario_docnorma">
                                    <input type="hidden" id="id_docnorma" name="id_docnorma" />

                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="limpiarDocnorma();">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4" style="padding-bottom: 8px">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="tipo_doc_actual" name="tipo_doc_actual" />
                                                            <div class="input-group">
                                                                <span class="input-group-addon" id="basic-addon1">
                                                                ...
                                                                <select required="" class="form-control" name="id_tipo_doc">
                                                                    ...
                                                                    <option value="2"> LEYES</option>
                                                                    <option value="3"> ESTATUTOS</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
