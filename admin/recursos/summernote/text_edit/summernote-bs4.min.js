            ...
            e.fade && t.addClass("fade"),
                ...
                t.html(
                    [
                        ...
                        e.title
                            ? '    <div class="modal-header">      <h4 class="modal-title">' + e.title + '</h4>      <button type="button" class="close" data-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button>    </div>'
                            : "",
        ...
        g = o('<div class="form-check"></div>', function (t, e) {
            t.html(
                [
                    ...
                    ' <input role="checkbox" type="checkbox" class="form-check-input"' + (e.id ? ' id="' + e.id + '"' : ""),
                    e.checked ? " checked" : "",
        ...
        b = {
            ...
            button: function (t, e) {
                return o('<button type="button" class="note-btn btn btn-light btn-sm" role="button" tabindex="-1">', function (t, e) {
                    e && e.tooltip && t.attr({ title: e.tooltip, "aria-label": e.tooltip }).tooltip({ container: void 0 !== e.container ? e.container : "body", trigger: "hover", placement: "bottom" });
                })(t, e);
            },
            ...
            createLayout: function (t, e) {
                ...
                return (
                    o.insertAfter(t),
                    { note: t, editor: o, toolbar: o.find(".note-toolbar"), editingArea: o.find(".note-editing-area"), editable: o.find(".note-editable"), codable: o.find(".note-codable"), statusbar: o.find(".note-statusbar") }
                );
            },
            ...
            return (
                ...
                (r.prototype.splitText = function () {
                    ...
                    return (
                        ...
                        Nt.isText(this.sc) && !Nt.isEdgePoint(this.getStartPoint()) && ((e.sc = this.sc.splitText(this.so)), (e.so = 0), t && ((e.ec = e.sc), (e.eo = this.eo - this.so))),
        ...
        Ft = {
            ...
            createFromNode: function (t) {
                ...
                return (
                    ...
                    Nt.isBR(n) ? ((i = Nt.listPrev(n).length - 1), (n = n.parentNode)) : Nt.isVoid(n) && ((i = Nt.listPrev(n).length), (n = n.parentNode)),
                    this.create(e, o, n, i)
                );
            },
    ...
    var Ht = (function () {
            ...
            return (
                (t.prototype.makeSnapshot = function () {
                    ...
                    return { contents: this.$editable.html(), bookmark: t ? t.bookmark(this.editable) : { s: { path: [], offset: 0 }, e: { path: [], offset: 0 } } };
                }),
            ...
            (this.getActionList = function () {
                ...
                t && t.tagName && ("td" === t.tagName.toLowerCase() || "th" === t.tagName.toLowerCase())
                    ? ((f.colPos = t.cellIndex),
                      t.parentElement && t.parentElement.tagName && "tr" === t.parentElement.tagName.toLowerCase() ? (f.rowPos = t.parentElement.rowIndex) : console.error("Impossible to identify start Row point.", t))
    ...
    var Ot,
                ...
                (t.prototype.deleteRow = function (t) {
                    for (
                        var e = Nt.ancestor(t.commonAncestor(), Nt.isCell),
                            ...
                            i = o[0].rowIndex,
                            r = new Mt(e, Mt.where.Row, Mt.requestAction.Delete, k(o).closest("table")[0]).getActionList(),
                            s = 0;
                        s < r.length;
                        s++
                    )
                        if (r[s]) {
                            ...
                            switch (r[s].action) {
                                ...
                                case Mt.resultAction.AddCell:
                                    ...
                                    c &&
                                        (2 < d
                                            ? (d--, u.insertBefore(h, u.cells[n]), u.cells[n].setAttribute("rowSpan", d), (u.cells[n].innerHTML = ""))
                                            : 2 === d && (u.insertBefore(h, u.cells[n]), u.cells[n].removeAttribute("rowSpan"), (u.cells[n].innerHTML = "")));
                                    continue;
                                case Mt.resultAction.SubtractSpanCount:
                                    c &&
                                        (2 < d
                                            ? (d--, a.setAttribute("rowSpan", d), l.rowIndex !== i && a.cellIndex === n && (a.innerHTML = ""))
                                            : 2 === d && (a.removeAttribute("rowSpan"), l.rowIndex !== i && a.cellIndex === n && (a.innerHTML = "")));
                                    continue;
                ...
                (t.prototype.deleteCol = function (t) {
                    for (
                        var e = Nt.ancestor(t.commonAncestor(), Nt.isCell),
                            o = k(e).closest("tr"),
                            n = o.children("td, th").index(k(e)),
                            i = new Mt(e, Mt.where.Column, Mt.requestAction.Delete, k(o).closest("table")[0]).getActionList(),
                            r = 0;
                        r < i.length;
                        r++
                    )
        ...
        jt = (function () {
            function t(t) {
                ...
                for (
                    var e = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "formatBlock", "removeFormat", "backColor"], o = 0, n = e.length;
                    o < n;
                    o++
                )
                    (this[e[o]] = (function (e) {
            ...
            return (
                ...
                (t.prototype.isLimited = function (t, e) {
                    return (
                        (t = t || 0),
                        (void 0 === e || !(Lt.isMove(e.keyCode) || e.ctrlKey || e.metaKey || N.contains([Lt.code.BACKSPACE, Lt.code.DELETE], e.keyCode))) &&
                            ...
                            .on("drop", function (t) {
                                ...
                                t.preventDefault(),
                                    n && n.files && n.files.length
                                        ? (i.$editable.focus(), i.context.invoke("editor.insertImagesOrCallback", n.files))
            ...
            return (
                (t.prototype.representShortcut = function (t) {
                    ...
                    return this.options.shortcuts && e
                        ? (z.isMac && (e = e.replace("CMD", "⌘").replace("SHIFT", "⇧")), " (" + (e = e.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")) + ")")
                        : "";
                }),
                            ...
                            children: [
                                this.button({
                                    ...
                                    click: function (t) {
                                        ...
                                        o && n
                                            ? p.context.invoke("editor.color", { backColor: e.attr("data-backColor"), foreColor: e.attr("data-foreColor") })
                                            : o
                                            ? p.context.invoke("editor.color", { backColor: e.attr("data-backColor") })
                                            : n && p.context.invoke("editor.color", { foreColor: e.attr("data-foreColor") });
                                    },
                                    callback: function (t) {
                ...
                (t.prototype.addToolbarButtons = function () {
                    ...
                    this.context.memo("button.style", function () {
                        return n.ui
                            .buttonGroup([
                                n.button({ className: "dropdown-toggle", contents: n.ui.dropdownButtonContents(n.ui.icon(n.options.icons.magic), n.options), tooltip: n.lang.style.style, data: { toggle: "dropdown" } }),
                                n.ui.dropdown({
                    ...
                    this.context.memo("button.bold", function () {
                        return n
                            .button({ className: "note-btn-bold", contents: n.ui.icon(n.options.icons.bold), tooltip: n.lang.font.bold + n.representShortcut("bold"), click: n.context.createInvokeHandlerAndUpdateState("editor.bold") })
                            .render();
                    }),
                        ...
                        this.context.memo("button.superscript", function () {
                            return n
                                .button({ className: "note-btn-superscript", contents: n.ui.icon(n.options.icons.superscript), tooltip: n.lang.font.superscript, click: n.context.createInvokeHandlerAndUpdateState("editor.superscript") })
                                .render();
                        }),
                        this.context.memo("button.subscript", function () {
                            return n
                                .button({ className: "note-btn-subscript", contents: n.ui.icon(n.options.icons.subscript), tooltip: n.lang.font.subscript, click: n.context.createInvokeHandlerAndUpdateState("editor.subscript") })
                                .render();
                        }),
                        this.context.memo("button.fontname", function () {
                            ...
                            return (
                                ...
                                n.ui
                                    .buttonGroup([
                                        n.button({ className: "dropdown-toggle", contents: n.ui.dropdownButtonContents('<span class="note-current-fontname"/>', n.options), tooltip: n.lang.font.name, data: { toggle: "dropdown" } }),
                                        n.ui.dropdownCheck({
                        ...
                        this.context.memo("button.fontsize", function () {
                            return n.ui
                                .buttonGroup([
                                    n.button({ className: "dropdown-toggle", contents: n.ui.dropdownButtonContents('<span class="note-current-fontsize"/>', n.options), tooltip: n.lang.font.size, data: { toggle: "dropdown" } }),
                                    n.ui.dropdownCheck({
                        ...
                        this.context.memo("button.ol", function () {
                            return n
                                .button({ contents: n.ui.icon(n.options.icons.orderedlist), tooltip: n.lang.lists.ordered + n.representShortcut("insertOrderedList"), click: n.context.createInvokeHandler("editor.insertOrderedList") })
                                .render();
                        });
                    ...
                    this.context.memo("button.justifyLeft", C.invoke(r, "render")),
                        ...
                        this.context.memo("button.paragraph", function () {
                            return n.ui
                                .buttonGroup([
                                    n.button({ className: "dropdown-toggle", contents: n.ui.dropdownButtonContents(n.ui.icon(n.options.icons.alignLeft), n.options), tooltip: n.lang.paragraph.paragraph, data: { toggle: "dropdown" } }),
                                    n.ui.dropdown([n.ui.buttonGroup({ className: "note-align", children: [r, s, a, l] }), n.ui.buttonGroup({ className: "note-list", children: [c, d] })]),
                                ])
                                .render();
                        }),
                        this.context.memo("button.height", function () {
                            return n.ui
                                .buttonGroup([
                                    n.button({ className: "dropdown-toggle", contents: n.ui.dropdownButtonContents(n.ui.icon(n.options.icons.textHeight), n.options), tooltip: n.lang.font.height, data: { toggle: "dropdown" } }),
                                    n.ui.dropdownCheck({
                        ...
                        this.context.memo("button.table", function () {
                            return n.ui
                                .buttonGroup(
                                    [
                                        n.button({ className: "dropdown-toggle", contents: n.ui.dropdownButtonContents(n.ui.icon(n.options.icons.table), n.options), tooltip: n.lang.table.table, data: { toggle: "dropdown" } }),
                                        n.ui.dropdown({
                                    ...
                                    ],
                                    {
                                        callback: function (t) {
                                            t.find(".note-dimension-picker-mousecatcher")
                                                .css({ width: n.options.insertTableMaxSize.col + "em", height: n.options.insertTableMaxSize.row + "em" })
                        ...
                        this.context.memo("button.hr", function () {
                            return n
                                .button({ contents: n.ui.icon(n.options.icons.minus), tooltip: n.lang.hr.insert + n.representShortcut("insertHorizontalRule"), click: n.context.createInvokeHandler("editor.insertHorizontalRule") })
                                .render();
                        }),
                            ...
                            c.ui.onDialogShown(c.$dialog, function () {
                                ...
                                a.prop("checked", o),
                                    s.one("click", function (t) {
                                        t.preventDefault(), n.resolve({ range: l.range, url: r.val(), text: i.val(), isNewWindow: a.is(":checked") }), c.ui.hideDialog(c.$dialog);
                                    });
                            }),
            ...
            return (
                ...
                (t.prototype.handleKeydown = function (t) {
                    this.$popover.is(":visible") &&
                        (t.keyCode === Lt.code.ENTER ? (t.preventDefault(), this.replace()) : t.keyCode === Lt.code.UP ? (t.preventDefault(), this.moveUp()) : t.keyCode === Lt.code.DOWN && (t.preventDefault(), this.moveDown()));
                }),
                    ...
                    if (!N.contains([Lt.code.ENTER, Lt.code.UP, Lt.code.DOWN], t.keyCode)) {
                        ...
                        if (this.hints.length && n) {
                            ...
                            i &&
                                ...
                                "top" === this.direction ? this.$popover.css({ left: i.left, top: i.top - this.$popover.outerHeight() - 5 }) : this.$popover.css({ left: i.left, top: i.top + i.height + 5 }));
                        } else this.hide();
                    }
                }),
                (t.prototype.show = function () {
