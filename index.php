...
<!-- COMUNICADOS -->
<div class="popular page_section" style="padding: 8px">
 <div class="container">
   <div class="row">
...
>>>>>>> 1175da83df10f8e090416707543110d1433ad6fe
            </div>
          </div>
        </div>
        <div class="row my-5">
...
<div class="row">
  <!-- ===========================INFERIORR IZQUIERDA 1===================== -->
<?php while ($row1 = $eventos_sii->fetch_assoc()) {
    ?>
  <div class="col-lg-6">
    <div class="single-rpost d-sm-flex align-items-center padding-2primeros" data-aos="fade-left" data-aos-delay="200"
    ...
    echo $row1['titulo'];?>
      ...
      <div class="col-lg-6" style="padding: 0px 0px !important">
        <div class="post-thumb  portfolio-item" data-toggle="modal" data-target="#portfolioModal1">
         ...
         <img class="img-fluid" src="multimedia/eventos/<?php echo $row1['foto']; ?>" style="height: 320px; width: 500px;" alt="Post 1">
       </div>
     </div>
   </div>
 </div>
...
<?php }?>
 ...
 <?php while ($row2 = $eventos_sdd->fetch_assoc()) {
    ?>
  <div class="col-lg-6">
    <div class="single-rpost d-sm-flex align-items-center padding-2primeros" data-aos="fade-left" data-aos-duration="800">
      ...
      <div class="post-thumb portfolio-item" data-toggle="modal" data-target="#portfolioModal2">
        ...
        <img class="img-fluid" src="multimedia/eventos/<?php echo $row2['foto']; ?>" style="height: 320px; width: 500px;" alt="Post 2">
      </div>
...
<!-- ===========================INFERIORR IZQUIERDA 3===================== -->
<?php while ($row3 = $eventos_iii->fetch_assoc()) {
    ?>
  <div class="col-lg-6">
    <div class="single-rpost d-sm-flex align-items-center padding-2ultimos" data-aos="fade-left" data-aos-delay="200"
    data-aos-duration="800">
    <div class="row">
      <div class="col-lg-6" style="padding: 40px 0px 0px 0px !important" >
        <div class="post-content text-sm-right">
    ...
    echo $row3['titulo'];?>
      ...
      <div class="col-lg-6" style="padding: 0px 0px !important">
        <div class="post-thumb  portfolio-item" data-toggle="modal" data-target="#portfolioModal3">
         ...
         <img class="img-fluid" src="multimedia/eventos/<?php echo $row3['foto']; ?>" style="height: 320px; width: 500px;" alt="Post 1">
       </div>
     </div>
   </div>
 </div>
...
<?php while ($row4 = $eventos_idd->fetch_assoc()) {
    ?>
  <div class="col-lg-6">
    <div class="single-rpost d-sm-flex align-items-center padding-2ultimos" data-aos="fade-right" data-aos-delay="200"
    data-aos-duration="800">
    <div class="post-thumb  portfolio-item" data-toggle="modal" data-target="#portfolioModal4">
      <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
       <div class="portfolio-item-caption-content text-center text-black"><i class="fas fa-plus fa-3x"></i></div>
     </div>
     <img class="img-fluid" src="multimedia/eventos/<?php echo $row4['foto']; ?>" style="height: 320px; width: 500px;" alt="Post 1">
   </div>
   <div class="post-content">
    <time datetime="2019-04-06T13:53">15 Oct, 2019</time>
    <h3>
