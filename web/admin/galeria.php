			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<h1>
						...
						Galería
						<small>Gestiona la galeria de la institución</small>
					</h1>
					<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="box box-solid">
								<div class="box-header with-border">
									<center>
										<h5 class="box-title">Lista de imagenes</h5>
									</center>
								</div>
								<div class="box-body">
					...
					<div class="modal-content">
						<form action="">
							<div class="modal-header">
								...
								<h4 class="modal-title"><i class="fa fa-newspaper-o"></i> Agregar nuevo Imagen</h4>
							</div>
							<div class="modal-body">

								<input type="hidden" name="idgaleria" id="idgaleria">
								<div class="row">
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<label for="foto">Imagen de la imagen</label>
