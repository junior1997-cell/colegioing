...
define('CAMPAIGN_ID', "f98ed9644fc21a8324eb43ba4f778b2b");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'b3b652d025e83d18853fa76187e67009');
define('MP_PARAM_NAME', 'alsess');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '1f49dcbcc61426dde1552ae726e919f4');
define('CHECK_MCPROXY_VALUE', '89852856aad608d7c905979899f0c3a596fd576be2a0315c0289da162ba8858e');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '6593.3');
